...
class WeaterTableViewController: UITableViewController {
    
    var weatherLists : [Weather] = WeatherBuilder.sharedInstance.weatherList
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       weatherTableViewCell.weatherConditionImageView.image = UIImage(named: weatherinfo.icon)
       weatherTableViewCell.descriptionLabel.text = weatherinfo.description
